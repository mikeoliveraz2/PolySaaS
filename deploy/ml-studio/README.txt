...
-----
  ...
  docker run -e POLYSAAS_CORE_BASE_URL=http://host.docker.internal:8000 -p 8010:8000 ml-studio

Blueprint
---------
Service **PolySaaS-ML-Studio** — `deploy/ml-studio/Dockerfile`,
context `deploy/ml-studio`.
