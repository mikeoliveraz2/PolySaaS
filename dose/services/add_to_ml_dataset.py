"""
AddToMLDataset — append conversation/context rows to a JSONL training dataset.
"""
...
class AddToMLDataset(AtomicServiceBase):

    @staticmethod
    def get_parameters(parameters, key='AddToMLDataset'):
    ...
    def execute_and_save(request, instruction_row):
        ...
        filepath = AddToMLDataset._dataset_dir() / filename
        ...
        try:
            ...
            result = service_result('AddToMLDataset', status='error', error=str(exc))
