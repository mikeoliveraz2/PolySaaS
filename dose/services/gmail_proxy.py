...
class GmailProxy(AtomicServiceBase):
    ...
    def execute_and_save(request, instruction_row):
        ...
        if gmail_action == 'inbox':
            return GmailProxy._handle_inbox(request, oauth_token, orchestration_data)
        elif gmail_action == 'compose':
            return GmailProxy._handle_compose(request, oauth_token, orchestration_data)
        else:
            return GmailProxy._handle_default_gmail(request, oauth_token, orchestration_data)
    ...
    def _handle_inbox(request, oauth_token, orchestration_data=None):
        ...
        try:
            ...
            gmail_response = GmailProxy._generate_gmail_interface(
            ...
            try:
                ...
                messages_data = []
                labels_data = []
                return GmailProxy._generate_gmail_interface(request, profile_data, messages_data, labels_data)
