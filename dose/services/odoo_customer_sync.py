...
class OdooCustomerSyncService(AtomicServiceBase):
    ...
    def _get_odoo_config(request):
        ...
        try:
            ...
            odoo_ep = PassThroughEndpoint.objects.filter(trigger_path='odoo', is_enabled=True).first()
            if odoo_ep:
