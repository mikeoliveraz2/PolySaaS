...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dose', '0014_passthroughendpoint_inject_proxy_script'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endpoint_name', models.CharField(blank=True, help_text='Name of endpoint being debugged', max_length=200)),
                ...
                ('har_data', models.JSONField(blank=True, help_text='Full HAR format data', null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-captured_at'],
                'indexes': [models.Index(fields=['-captured_at'], name='dose_traffi_capture_d016d1_idx'), models.Index(fields=['url'], name='dose_traffi_url_8db12d_idx'), models.Index(fields=['endpoint_name'], name='dose_traffi_endpoin_d4c682_idx')],
            },
        ),
    ]
