"""
Create the Cross-App Sync page on polysaas.online and upload the Dolibarr sniff screenshots.
Also updates Dynamic Orchestration and PolySniffer pages to link to this new page.
"""
...
IMAGES = [
    {
        "file": "PolySniffer-Live-Capture-Dolibarr-ERP-03-22-2026_10_41_AM.png",
    ...
    {
        "file": "Select-pass-through-endpoint-to-change-D-O-S-E-Administration-03-22-2026_10_44_AM.png",
    ...
    {
        "file": "Login-19-0-2-03-22-2026_10_43_AM.png",
    ...
    {
        "file": "Setup-03-22-2026_10_43_AM.png",
        "wp_name": "crossapp-dolibarr-setup-thirdparties.png",
        "alt": "Dolibarr admin dashboard with Third-parties menu highlighted",
        "caption": "Navigating to Third-parties module — the Members menu is also visible",
    },
    {
        "file": "Third-parties-03-22-2026_10_43_AM.png",
        "wp_name": "crossapp-dolibarr-thirdparties-menu.png",
        "alt": "Dolibarr Third-parties sidebar showing New Customer option",
        "caption": "Third-parties sidebar: New Customer selected, starting the capture flow",
    },
    {
        "file": "New-Third-Party-prospect-customer-vendor--03-22-2026_10_42_AM.png",
    ...
    {
        "file": "Annotate-Image-03-22-2026_10_42_AM.png",
    ...
    {
        "file": "Mike-Oliver-Card-03-22-2026_10_41_AM.png",
        "wp_name": "crossapp-dolibarr-customer-created.png",
        "alt": "Dolibarr customer record for Mike Oliver showing synced data",
        "caption": "Customer created: Mike Oliver with code CU2603-00001 — ready to sync to Odoo",
    },
    {
        "file": "Odoo-Contacts-Mike-Oliver-Grid-03-22-2026.png",
    ...
    {
        "file": "Odoo-Contact-Mike-Oliver-Detail-03-22-2026.png",
...
for img in IMAGES:
    filepath = os.path.join(UPLOADS, img["file"])
...
# ============================================================
# STEP 2: Build the Cross-App Sync page content
# ============================================================
...
<!-- /wp:html -->'''.format(
    home=HOME_URL,
    img_sniffer=img_url("crossapp-polysniffer-dolibarr-capture.png"),
    img_admin=img_url("crossapp-passthrough-endpoints-admin.png"),
    img_login=img_url("crossapp-dolibarr-login.png"),
    img_setup=img_url("crossapp-dolibarr-setup-thirdparties.png"),
    img_thirdparties=img_url("crossapp-dolibarr-thirdparties-menu.png"),
    img_form=img_url("crossapp-dolibarr-new-thirdparty-form.png"),
    img_submit=img_url("crossapp-dolibarr-create-thirdparty-submit.png"),
    img_result=img_url("crossapp-dolibarr-customer-created.png"),
    img_odoo_grid=img_url("crossapp-odoo-contacts-grid-mike-oliver.png"),
    img_odoo_detail=img_url("crossapp-odoo-contact-mike-oliver-detail.png"),
)
...
if existing:
    ...
    r2 = s.post(f"{AZURE}/wp-json/wp/v2/pages/{pid}", json={
        "content": page_content,
        "title": "Cross-Application Sync",
        "status": "publish",
    })
else:
    print("Creating new page...")
    r2 = s.post(f"{AZURE}/wp-json/wp/v2/pages", json={
        "slug": SLUG,
        "content": page_content,
        "title": "Cross-Application Sync",
        "status": "publish",
...
if r2.status_code in (200, 201):
    ...
    SYNC_PAGE_URL = f"{HOME_URL}/cross-app-sync/"
else:
...
if dyn_pages:
    ...
    if 'cross-app-sync' not in content:
        ...
        r2 = s.post(f"{AZURE}/wp-json/wp/v2/pages/{dp['id']}", json={"content": new_content})
        if r2.status_code == 200:
            print(f"  OK: Added cross-app sync link to Dynamic Orchestration page")
        else:
...
if sniffer_pages:
    ...
    if 'cross-app-sync' not in content:
        ...
        r2 = s.post(f"{AZURE}/wp-json/wp/v2/pages/{sp['id']}", json={"content": new_content})
        if r2.status_code == 200:
            print(f"  OK: Added cross-app sync link to PolySniffer page")
        else:
            print(f"  FAILED: {r2.status_code}")
    else:
        print("  Link already present, skipping")
