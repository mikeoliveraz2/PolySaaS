...
# BINGO: Odoo Multi-Tenant DB Isolation — see documentation/BINGO_ODOO_MULTITENANT_ISOLATION_2026-07-31.md
...
JAZZMIN_SETTINGS = {
    ...
    "SECONDARY_COLOR": "#6c757d",
     "topmenu_links": [
        ...
        {"name": "PolySaaS", "url": "/dose/home/", "permissions": ["auth.view_user"], "icon": "fas fa-gem fa-lg"},

        # Url that gets reversed (Permissions can be added)
        {"name": "Home",  "url": "/dose/home/", "permissions": ["auth.view_user"]},

        # external url that opens in a new window (Permissions can be added)
        {"name": "Support", "url": "https://github.com/farridav/django-jazzmin/issues", "new_window": True},

        {"name": "Toggle light/dark", "url": "#ps-theme-toggle", "permissions": ["auth.view_user"]},
...
# --- LEMON SQUEEZY CONFIGURATION (Founder Beta Circle) ---
LEMON_SQUEEZY_API_KEY = env('LEMON_SQUEEZY_API_KEY', default='')
LEMON_SQUEEZY_PRODUCT_ID = env('LEMON_SQUEEZY_PRODUCT_ID', default='')
...
# Database-manager master password (create/drop databases) — must match odoo.conf's admin_passwd.
# Used only for per-tenant database provisioning (dose/services/odoo_tenant_provisioner.py).
...
LLM_ROUTER_LITE_MODEL = env("LLM_ROUTER_LITE_MODEL", default="claude-haiku-4-5-20251001")
...
LLM_ROUTER_ADMIN_CHAT_MODEL = env("LLM_ROUTER_ADMIN_CHAT_MODEL", default="claude-sonnet-4-6")
...
LOGIN_REDIRECT_URL = '/dose/home/'
ACCOUNT_LOGOUT_REDIRECT_URL = '/accounts/login/'

# Staff and subscribers share one login; CustomAccountAdapter lands everyone on /dose/home/ by default.
...
MIDDLEWARE = [
    ...
    'dose.middleware.passthrough_stray_root_relay.PassthroughStrayRootRelayMiddleware',
