...
urlpatterns = [
    ...
    path('pt/dose/<str:trigger>/', pt_dose_generic_passthrough_view, name='pt_dose_generic'),
    path('pt/dose/<str:trigger>/<path:subpath>/', pt_dose_generic_passthrough_view, name='pt_dose_generic_subpath'),
