...
instr_section = (
    ...
    '<p>When any POST request passes through the proxy and its URL contains <code>/societe/card.php</code>, this Instruction fires the <strong>EndpointDataExtractorService</strong>, '
