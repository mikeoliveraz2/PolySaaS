...
**March 2026 — Seeking $750K–$1.5M Seed**
...
| Infrastructure & ops | 15% | $150K | GCP production, BigQuery, networking, security hardening. Offset by up to $350K Google for Startups Cloud credits (AI Tier qualification targeted post-deployment), targeting near-zero net GCP burn in the first 18–24 months. |
...
**Application:** [Google for Startups Cloud Program — AI tier](https://cloud.google.com/startup/ai)
...
| Salesforce AppExchange / broad platforms | No | Varies | Marketplace | No | We are self-hosted, multi-app, open-core options; they are vendor-locked. |
...
- **Pain Point Fit** — Many Liferay customers have large installs but struggle with integration to other SaaS tools (Odoo, Nextcloud, Mattermost). Our proxy handlers + atomic services solve this without disrupting their Liferay core.
- **Revenue Upsell** — Resellers can bundle our PolySaaS to increase deal size (e.g., "Liferay portal + our PolySaaS AI backend").
- **Partner Program Alignment** — Liferay's own program emphasizes co-marketing, lead sharing, and technical enablement — our partner page can mirror this (white-label, revenue share, training).
- **Market Opportunity** — With ~13,000+ companies using Liferay and hundreds of partners, even 1–5% conversion could yield significant early traction.
...
**End of 2026:** ~45 customers, ~$794K ARR run rate, 19 active partners. Penetration: 0.3% of Liferay companies, 6% of partners.
...
**End of 2027:** ~275 customers, ~$4.85M ARR, 71 partners. Penetration: 2.0% of Liferay companies, 24% of partners.
...
**End of 2028:** ~895 customers, ~$15.8M ARR, 100+ partners across multiple ecosystems. Penetration: 6.5% of Liferay companies + emerging Odoo/Nextcloud channels.
...
Django's partner and developer ecosystem provides a useful benchmark for PolySaaS's potential reach, as Django is a key enabler for our platform's plugins and extensibility. Early Market Research for DOSE when it was in the concept phase just as a plugin application for Django to add Dynamic Orchestration had good results with 8 leading Django SIs. (2 years ago)
...
|------|------------------------|------------------------|-------------------------------|-----------------|---------------------|
| 1 | Mid-Market Companies (50–999 employees) | 80–130 | Need best-of-breed tools for every department | Very High — want consolidation without losing favorite tools | ~$50–$100B SAM |
| 2 | Enterprise (1,000+ employees) | 150–288 | Complex orgs, legacy + modern tools, compliance needs | High — large Liferay/Django users already in scope | $200B+ global enterprise SaaS spend |
| 3 | Professional Services Firms | 60–120 | Project-based → tools for CRM, time tracking, invoicing, collaboration | High — Liferay-style portals common | $10–$30B SAM |
| 4 | Tech Startups & Scale-Ups (10–500 employees) | 40–100 | Fast-moving, adopt many tools quickly | High — Django devs common; want orchestration + AI peers | $20–$50B (fast-growing) |
| 5 | Healthcare & Life Sciences | 100–200 | Compliance-heavy (EHR, billing, telehealth, CRM, analytics) | Medium-High — security focus aligns with proxy + atomic layer | $15–$40B |
| 6 | Financial Services & Insurance | 120–250 | Regulatory needs (CRM, compliance, payments, analytics) | Medium-High — Liferay strong here | $30–$60B |
...
| 10 | Retail & E-Commerce | 70–140 | POS, CRM, inventory, marketing, analytics | Medium — Odoo/WordPress common | $20–$40B |

### Quick Prioritization for PolySaaS

**Highest Potential (Next 12–18 months):**
- Mid-Market Companies (80–130 apps) — largest volume, easiest to convert via waitlist & demos.
- Liferay/Django Partners & Enterprises (already identified) — strong overlap with high SaaS count.
- Professional Services & Tech Startups — fast decision cycles, high tool sprawl, open to open-source/self-hosted.

**Medium-Term Expansion:**
- Healthcare, Finance, Manufacturing — higher revenue per customer but longer sales cycles & compliance needs.
- Government/Non-Profit — large installs but slow procurement.

**Low-Hanging Fruit:**
- Target companies already using Liferay + Odoo/Nextcloud/Mattermost — they're closest to our current stack and have the pain we solve.
...
**Subject:** Extending your Liferay installs with zero-code AI orchestration
...
>
> We're building PolySaaS — a backend layer that adds atomic services, real-time orchestration, and AI peers (Grok, Claude, Gemini) to existing Liferay installs — without disrupting the core platform.
>
...
*Michael Oliver — Founder, PolySaaS Online*
