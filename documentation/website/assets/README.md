# Website page assets (PolySaaS marketing)

| File | Use |
|------|-----|
| `ml-icon.svg` | Machine Learning feature icon — upload to **Media Library** for menus/cards, or use the **inline SVG** already embedded in `machine-learning-page-content.html`. |
