"""Remove the Topflite aviation image from Gallery Images page."""
...
target = "7db4423a-e6dd-4f25-be44-213d4ad0affa"
idx = raw.find(target)
if idx < 0:
...
if r2.status_code == 200:
    print("  SUCCESS! Topflite image removed from gallery.")
else:
